...
from xai.summary.summary_pb2 import Explain
from xai.summary.summary_writer import SummaryWriter
from xai.benchmark import Localization
from xai.benchmark.attribution.metric import AttributionMetric
from xai.benchmark.attribution.metric import LabelSensitiveMetric
from xai.benchmark.attribution.metric import LabelAgnosticMetric
from xai.explanation import RISE
from xai.explanation.attribution import Attribution
...
class ImageClassificationRunner(_Verifier):
    ...
    Examples:
        ...
        >>> from xai.explanation import GuidedBackprop, Gradient
    ...
    def run(self):
        ...
        with SummaryWriter(self._summary_dir) as summary:
            print("Start running and writing......")
            begin = time()

            self._summary_timestamp = summary.timestamp
            if self._summary_timestamp is None:
                raise RuntimeError("Cannot get timestamp from summary writer!")
    ...
    def _run_inference(self, summary, threshold=0.5):
        ...
        Args:
            summary (SummaryWriter): The summary writer.
