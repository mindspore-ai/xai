...
请参考 [下载数据集](https://mindspore.cn/xai/docs/zh-CN/master/using_tbnet.html#id3) 以了解如何取得用例数据集及其文件格式。
...
- 框架
    ...
    - [MindSpore XAI](https://mindspore.cn/xai/docs/zh-CN/master/installation.html)
- 如需查看详情，请参见如下资源：
...
请参考 [使用TB-Net](https://mindspore.cn/xai/docs/en/master/using_tbnet.html) 以了解如何快快速入门。
