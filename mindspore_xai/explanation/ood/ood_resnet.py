...
# ============================================================================
"""ResNet for Out Of Distribution Network."""
import numpy as np
...
from .ood_net import OODUnderlying
...
class OODResNet(OODUnderlying):
    ...
    def __init__(self,
        ...
        self._feature_count = out_channels[3]
...
class OODResNet50(OODResNet):
    """OOD underlying classifier in ResNet50 architecture."""
    def __init__(self, num_classes):
        super(OODResNet50, self).__init__(ResidualBlock,
                                          [3, 4, 6, 3],
                                          [64, 256, 512, 1024],
                                          [256, 512, 1024, 2048],
                                          [1, 2, 2, 2],
